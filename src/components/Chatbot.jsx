...
function Chatbot() {
  ...
  const steps = [
    ...
    },
    {
      id: "welcomeUser",
      message:
        "Welcome to Travel Smart, {previousValue}! Would you like to go on a guided tour?",
      trigger: "tourPrompt",
    },
    {
      id: "tourPrompt",
    ...
    },
    {
      id: "tourStart",
      message:
        "Awesome! We have various destinations to explore right here on the homepage.",
      trigger: "nextOption",
    },
    {
      id: "nextOption",
    ...
    },
    {
      id: "footerInfo",
      message:
        "You can find our site map in the footer to locate all parts of the website.",
      trigger: "contactInfo",
    },
    {
      id: "contactInfo",
      message:
        "If you need assistance, feel free to contact us at support@travelsmart.com or via WhatsApp at +123456789.",
      trigger: "finalOption",
    },
    {
      id: "finalOption",
      options: [{ value: "end", label: "End Tour", trigger: "endTour" }],
    },
    {
      id: "endTour",
      message:
        "Thank you for visiting Travel Smart! We’re here if you need anything.",
      end: true,
    },
  ];
  ...
  return (
    <div className="z-10">
      ...
      {showChatbot && (
        <div
          className="fixed bg-tertiary cursor-pointer backdrop-blur-sm h-screen flex flex-col justify-end items-end  inset-0 bg-opacity-35 bottom-4 right-4  w-full   rounded-lg p-4 transition-all duration-500"
          style={{ zIndex: 1000 }}
        >
          {/* Close button */}
          <div className="flex  justify-end ">
            <button
              className="text-red-800       text-2xl hover:text-2.5xl duration-300 ease-linear font-semibold"
              onClick={handleButtonClick}
            >
              ✕
            </button>
